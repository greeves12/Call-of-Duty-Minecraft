        ...
        if(commandSender instanceof Player){
            ...
            if(p.hasPermission("cod.admin")){
                if(args[0].equalsIgnoreCase("create")){
                    if(args.length == 3){
                        String name = args[1];
                        if((args[2].equalsIgnoreCase("tdm")) || (args[2].equalsIgnoreCase("oitc")) || (args[2].equalsIgnoreCase("gun")) || (args[2].equalsIgnoreCase("kc")) || (args[2].equalsIgnoreCase("inf")) || (args[2].equalsIgnoreCase("CTF")) || (args[2].equalsIgnoreCase("ffa"))){
                        ...
                        p.sendMessage(Main.prefix + "§9Available GameModes are §6TDM §a, §6KC §e(Kill Confirmed) §a, §6OITC §e(One in the chamber), §6INF §e(Infected), §6CTF, §6FFA §e(Free for all), §6GUN §e(Gun Game)");
                ...
                if(args[0].equalsIgnoreCase("setspawn")){
                    if(args.length == 3){
                        ...
                        if(Main.arenas.contains(args[1])){
                            if(!ArenasFile.getData().getString("Arenas." + args[1] + ".Type").equalsIgnoreCase("OITC") && !ArenasFile.getData().getString("Arenas." + args[1] + ".Type").equalsIgnoreCase("FFA") && !ArenasFile.getData().getString("Arenas." + args[1] + ".Type").equalsIgnoreCase("GUN")){
                                p.sendMessage(Main.prefix + "§7Arena must be Free for All, Gun Game or One In The Chamber");
                                return true;
                            }
            ...
            if(p.hasPermission("cod.player")){
                ...
                if(args[0].equalsIgnoreCase("bugreport")){
                    p.sendMessage(Main.prefix + "§ehttps://github.com/greeves12/COD/issues");
                }
                ...
                if(args[0].equalsIgnoreCase("changelog")){
                    ...
                    p.sendMessage("§8- §3Added One in the Chamber");
                    p.sendMessage("§8- §3Added bug report command");
                ...
                if(args[0].equalsIgnoreCase("join")){
                    ...
                    if(Main.WaitingPlayers.size()+1 < Main.minplayers){
