    ...
    public void helpMe(CommandSender p, String[] args ){
        if(args.length == 1){
            ...
            if(args[1].equalsIgnoreCase("1")){
                p.sendMessage("§4§m |   »* |   >»  §r  §6[ §cCOD-Warfare Help §d· §e2/3§d· §6]  §4§m  «<   | *«   | §r");
                ...
                p.sendMessage(" §8- §3/cod bugreport §7- §bReport a bug to the author");
            }else if(args[1].equalsIgnoreCase("3")){
                p.sendMessage("§4§m |   »* |   >»  §r  §6[ §cCOD-Warfare Help §d· §e3/3§d· §6]  §4§m  «<   | *«   | §r");
